  ...
  return (
    <div className='search-box'>
      <fieldset className='categories'>
        ...
        <button type='button' className='nobutton'>
          <div className='category-box-online'>
            <a href='' className='go-online'>
              온라인 체험
            </a>
          </div>
        </button>
      ...
      <div className='schedule-search'>
        <div className='schedule-input-box'>
          <div className='place-box'>
            ...
            <input className='place-input' placeholder='어디로 여행가세요?' onChange={onChange} value={whereto}></input>
          </div>
        </div>
        <div className='checkin'>
          ...
          <button /*onClick = {this.alertStartDate}*/ className='checkin-button'></button>
          <button /*onClick = {this.alertEndDate}*/ className='checkin-button'></button>
        </div>
            ...
            <div className='the-number-add'>
              <div className='the-number-add-each-box'>
                ...
                <div className='adding-box'>
                  <button
                    className='thenumber-btn'
                    style={adults <= 0 ? { color: 'rgb(235, 235, 235)', borderColor: 'rgb(235, 235, 235)' } : undefined}
                    onClick={onClickMinusHandler}
                  >
                    -
                  </button>
                  <div>{adults < 0 ? 0 : adults}</div>
                  <button className='thenumber-btn' onClick={onClickPlusHandler}>
                    +
                  </button>
                </div>
              </div>
        ...
        <div className='gumsaek'>
          ...
          >
            <div className='btnbtn'>
              ...
              <span className='gumsaek-letter'>검색</span>
            </div>
          </button>
        </div>
      </div>
