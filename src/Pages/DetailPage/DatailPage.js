...
import { API_URL_5S } from '../../config';
import { AiFillStar, AiFillFire, AiOutlineWifi, AiFillIdcard } from 'react-icons/ai';
import { IoIosRestaurant, IoIosBed, IoIosCar, IoIosTv, IoIosLaptop, IoIosShirt, IoIosSnow } from 'react-icons/io';
        ...
        <div className='DatailPage'>
          <div className='productdetail-title'>
            ...
            <div className='productdetail-title-description'>
              <div className='productdetail-title-description-left'>
                ...
                <span className='starrating'>
                  {data.house_rating}
                  <span className='starrating-count'>({data.review_count})</span>
                </span>
                <span
                  className='superhost'
                  style={{
            ...
            <div className='detailimage'>
              <div className='detailimage-left'>{data.house_images ? <img src={data.house_images[0]} alt='' /> : ''}</div>
              ...
              <span className='view-allimage' onClick={() => this.setState({ detailslideShow: true })}>
                사진 모두 보기
              </span>
            </div>
          </div>
          <div className={!this.state.detailslideShow ? 'detailslide-hide' : 'detailslide-show'}>
            <DetailPageSlide slideShowToggle={this.slideShowToggle} house_images={data.house_images} />
          </div>
          ...
          <div className='detail-description-wrap'>
            <div className='detail-description'>
              <div className='description-title'>
                ...
                <span>
                  인원 {data.house_capacity}명 · 침실 {data.house_num_of_bedroom}개 · 침대 {data.house_num_of_bed}개 · 욕실
              ...
              <div className='description-explanation'>
                ...
                <span className='description-text'>
                  성산 일출봉 근처 드라마 공항가는 길의 촬영지였던 오조리 마을 안에 하우스가 있습니다 마을 안에는 호수와 바다를 품고 있는 이쁜
                  산책로가 있고 철새 도래지와 배우 이상윤의 작업실의 무대가 있는 곳 이기도 합니다. 제주도 독채 펜션이라고 해서 왜 비싸야 할까요?
                  두근두근 하우스는 합리적 가격과 최적의 가성비 갑의 쾌적한 환경을 품고 있는 독채 펜션으로 그 어느 곳에서도 느낄 수 없는 즐겁고
                  편안하게 묵으실 수 있는 보금자리입니다! 다른 곳들과 충분히 비교해 보시고 두근두근 하우스로 놀러 오세요~ 절대 후회 없는 제주도 여행의
                  일부분이 될 것입니다~^^
                  <br />
                  <br />
                  <strong>숙소</strong> <br />
          ...
          <div className='detail-information'>
            <div className='information-rating'>
              <h5>
                <AiFillStar />
                {data.house_rating}점(후기 {data.review_count}개)
              </h5>
              <div className='information-rating-wrap'>
                <div className='information-rating-box'>
                  청결도
                  <div>
                    <Line percent='88' strokeWidth='3' strokeColor='#222' width='130px' />
                    <span>4.4</span>
                  </div>
                </div>
                <div className='information-rating-box'>
                  정확성
                  <div>
                    <Line percent='90' strokeWidth='3' strokeColor='#222' width='130px' />
                    <span>4.5</span>
                  </div>
                </div>
                <div className='information-rating-box'>
                  의사소통
                  <div>
                    <Line percent='98' strokeWidth='3' strokeColor='#222' width='130px' />
                    <span>4.9</span>
                  </div>
                </div>
                <div className='information-review-box'>
                  위치
                  <div>
                    <Line percent='100' strokeWidth='3' strokeColor='#222' width='130px' />
                    <span>5.0</span>
                  </div>
                </div>
                <div className='information-rating-box'>
            ...
            <div className='information-review'>
              <div className='information-review-box'>
                <div className='information-review-box-namedate'>
                  <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRPM2Yoox_vvsCL5FkmzQmq-WyjBLXyauquxQ&usqp=CAU' alt='' />
                  <ul>
                    <li>형준</li>
                    <li>2020년 7월</li>
                  </ul>
                ...
                <p>
                  조용한 제주도 마을을 경험해보기 좋은 숙소입니다.시설과 인테리어도 깔끔하며, 현무암으로 둘어쌓인 작은 마당 또한 제주도를 느끼기에
                  너무 좋습니다.
                </p>
              </div>
              <div className='information-review-box'>
            ...
            <div className='information-host'>
              ...
              <ul className='host-description'>
                <li>
                  <AiFillStar />
                  후기 {data.review_count}개
                </li>
                <li style={!data.house_superhost ? { display: 'none' } : { display: 'inline-block' }}>
                  <AiFillIdcard />
                  슈퍼호스트
                </li>
              </ul>
              <span>
                ...
                <br /> <br />
                여운을 찾아오시는 분들께 늘 만족스러운 곳이 될 수 있도록 최선을 다 하겠습니다 <br />
                <br />
                숙박 중 게스트와의 교류
                <br /> - 체크인 당일날 이용사항 메시지와 함께 저희와 연락가능한 전화번호를 안내해드리고 있습니다!
                <br /> - 문의사항은 프라이버시를 위해 최대한 메시지와 통화로 답변 해드립니다 <br />- 위급상황시 호스트와 만나실수 있습니다 <br />
                <br />
            ...
            <div className='information-caution'>
              ...
              <div className='caution-wrap'>
                ...
                <ul>
                  ...
                  <li>그 이후로는 체크인 전에 취소하면 첫 1박 요금과 서비스 수수료를 제외하고 50%가 환불됩니다.</li>
                </ul>
              </div>
            </div>
          </div>
